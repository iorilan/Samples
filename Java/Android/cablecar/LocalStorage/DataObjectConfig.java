...
public class DataObjectConfig extends SQLiteOpenHelper
{
    public static abstract class ConfigTableInfo implements BaseColumns {
        ...
        public static final String KEY_DEFAULT_STATION_ID = "DefaultStationId";
        public static final String KEY_DEFAULT_SCAN_DIRECTION = "DefaultScanDirection";
        public static final String KEY_ADMIN_PIN = "AdminPinCodes";
        public static final String KEY_FACILITYINFO = "AllFacilities";
        public static final String KEY_OPERATIONINFO = "AllOperations";
