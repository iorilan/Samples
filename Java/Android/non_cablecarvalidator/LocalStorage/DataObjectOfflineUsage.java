...
public class DataObjectOfflineUsage extends SQLiteOpenHelper {
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        db.execSQL("DROP TABLE "+OfflineUsageTableInfo.TABLE_NAME);
    ...
    public void add(DataObjectOfflineUsage dataObject, String ticketNo, String facilityId, String operationId, String ticketCondition){
        ...
        cv.put(OfflineUsageTableInfo.OPERATOR_NAME, LoginActivity.LoginUserName);
    ...
    public Cursor getAll(DataObjectOfflineUsage dop){
        ...
        String[] columns = {OfflineUsageTableInfo.USAGE_DATE, OfflineUsageTableInfo.TICKETNUMBER,
                OfflineUsageTableInfo.FACILITY_ID, OfflineUsageTableInfo.OPERATION_ID,
                OfflineUsageTableInfo.VALIDATOR_ID, OfflineUsageTableInfo.OPERATOR_NAME,
